...
** Metaprogram
- [ ] Type database for more efficient storage of types accross the program
- [ ] Some sort of get_type_info(&structure) function that makes the retrieval of type info better.
- [ ] The ability to do the same for members of structs get_member_info(structure_info, string_t member_name)
...
- [ ] The ability to do the same for enums
- [ ] Type table to allow the user to query for the type_info via type name as a string.
- [ ] Nested structure support
- [ ] Ignore #if 0 blocks completely
- [ ] A better way of parsing modifiers like "volatile", "const", "static", etc.
