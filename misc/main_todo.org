...
** IMMEDIATE TODO
- [ ] Simple shader preprocessor. It won't do anything insane, all it will do is look for "#include <file>" directives and handle them, spitting the processed file into the build directory.
- [ ] IMGUI interface...
