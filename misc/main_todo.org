...
** IMMEDIATE TODO
- [ ] Proper test suite that allows us to actually get REAL benchmarking data
...
- [ ] Replace malloc inside of the Linux sys_allocate and sys_free functions. It sucks.
