...
- [ ] Image manager should have the ability to provide "scratch images"
- [ ] Create our own custom GPU image format. Something like idImage

- [ ] We need to completely rework descriptors and how they function. Right now, everything in the shader
...
- [ ] We should migrate from whatever you want to call this asscan system to a "constant_buffer" system. This way,
...
- [ ] Perhaps some kind of "constant_buffer" object that maps the name of a buffer / uniform object inside a shader
...
- [ ] Instead of cacheing uniforms, we should just use "constant buffers"
