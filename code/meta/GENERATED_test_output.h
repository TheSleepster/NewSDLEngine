...
#define GENERATED_PROGRAM_TYPE_LIST(X) \
	...
	X(TYPE_stored_type, "stored_type") \
	X(TYPE_c_hash_table_allocate_fn_t, "c_hash_table_allocate_fn_t") \
	X(TYPE_c_hash_table_free_fn_t, "c_hash_table_free_fn_t") \
...
const static type_info_struct_asset_handle_t type_info_struct_asset_handle_t_const_data = {
	...
	.members = {
		...
		.material = {.name = "material", .type = TYPE_material_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_asset_handle_t.material)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_asset_handle_t), material))},
	}
};
...
const static type_info_struct_packet_t type_info_struct_packet_t_const_data = {
	...
	.members = {
		...
		.input_data = {.name = "input_data", .type = TYPE_input_data_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_packet_t.input_data)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_packet_t), input_data))},
	}
};
...
const static type_info_t GENERATED_type_table[] = {
	...
	{.name = "stored_type", .type = TYPE_stored_type, .size = sizeof(stored_type), .struct_info = null},
	{.name = "c_hash_table_allocate_fn_t", .type = TYPE_c_hash_table_allocate_fn_t, .size = sizeof(c_hash_table_allocate_fn_t), .struct_info = null},
	{.name = "c_hash_table_free_fn_t", .type = TYPE_c_hash_table_free_fn_t, .size = sizeof(c_hash_table_free_fn_t), .struct_info = null},
	...
	{.name = "render_pipeline_stencil_function_t", .type = TYPE_render_pipeline_stencil_function_t, .size = sizeof(render_pipeline_stencil_function_t), .struct_info = null},
	...
	{.name = "material_t", .type = TYPE_material_t, .size = sizeof(material_t), .struct_info = null},
