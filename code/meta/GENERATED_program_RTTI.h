...
#define GENERATED_PROGRAM_TYPE_LIST(X) \
	...
	X(TYPE_render_group_t, type_id(render_group_t), "render_group_t") \
...
struct type_info_enum_widget_flags_t {
	...
	union {
		...
		struct {
			...
			type_info_member_t UI_WIDGET_FLAG_HAS_TEXT;
			type_info_member_t UI_WIDGET_FLAG_MOUSE_CLICKABLE;
			type_info_member_t UI_WIDGET_FLAG_HOVERABLE;
			type_info_member_t UI_WIDGET_FLAG_CLICKABLE_BUTTON;
			type_info_member_t UI_WIDGET_FLAG_LABLED_BUTTON;
		}members;
	};
};
...
const static type_info_struct_render_group_t type_info_struct_render_group_t_const_data = {
	...
	.member_count = 2,
	.members = {
		.renderpass_ID = {.name = "renderpass_ID", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_group_t.renderpass_ID)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_group_t), renderpass_ID))},
		.shader_ID = {.name = "shader_ID", .type = TYPE_u64, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_group_t.shader_ID)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_group_t), shader_ID))},
	}
};
...
const static type_info_struct_widget_state_t type_info_struct_widget_state_t_const_data = {
	...
	.members = {
		...
		.toggled = {.name = "toggled", .type = TYPE_bool32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.toggled)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), toggled))},
...
const static type_info_enum_widget_flags_t type_info_enum_widget_flags_t_const_data = {
	...
	.members = {
		...
		.UI_WIDGET_FLAG_HAS_TEXT = {.name = "UI_WIDGET_FLAG_HAS_TEXT", .type = TYPE_widget_flags_t, .kind = META_TYPE_KIND_Enum, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(UI_WIDGET_FLAG_HAS_TEXT), .offset = UI_WIDGET_FLAG_HAS_TEXT},
		...
		.UI_WIDGET_FLAG_CLICKABLE_BUTTON = {.name = "UI_WIDGET_FLAG_CLICKABLE_BUTTON", .type = TYPE_widget_flags_t, .kind = META_TYPE_KIND_Enum, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(UI_WIDGET_FLAG_CLICKABLE_BUTTON), .offset = UI_WIDGET_FLAG_CLICKABLE_BUTTON},
		.UI_WIDGET_FLAG_LABLED_BUTTON = {.name = "UI_WIDGET_FLAG_LABLED_BUTTON", .type = TYPE_widget_flags_t, .kind = META_TYPE_KIND_Enum, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(UI_WIDGET_FLAG_LABLED_BUTTON), .offset = UI_WIDGET_FLAG_LABLED_BUTTON},
	}
};
...
enum render_group_t_member_list_enum {
	TYPE_RENDER_GROUP_T_MEMBER_renderpass_ID,
	TYPE_RENDER_GROUP_T_MEMBER_shader_ID,
};
...
enum widget_flags_t_member_list_enum {
	...
	TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_HAS_TEXT,
	TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_MOUSE_CLICKABLE,
	TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_HOVERABLE,
	TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_CLICKABLE_BUTTON,
	TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_LABLED_BUTTON,
};
...
#define GENERATED_TYPE_INFO_ENUM_NAME_MAP_LIST(X) \
	...
	X(TYPE_ENUM_LOOKUP_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_HAS_TEXT, "UI_WIDGET_FLAG_HAS_TEXT") \
	...
	X(TYPE_ENUM_LOOKUP_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_CLICKABLE_BUTTON, "UI_WIDGET_FLAG_CLICKABLE_BUTTON") \
	X(TYPE_ENUM_LOOKUP_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_LABLED_BUTTON, "UI_WIDGET_FLAG_LABLED_BUTTON") \
...
const static type_info_data_mapping_t GENERATED_enum_member_name_to_type_info_table[] = {
	...
	{.name = "UI_WIDGET_FLAG_HAS_TEXT", .member_enum = TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_HAS_TEXT, .type_info_ptr = (const type_info_struct*)&type_info_enum_widget_flags_t_const_data},
	...
	{.name = "UI_WIDGET_FLAG_CLICKABLE_BUTTON", .member_enum = TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_CLICKABLE_BUTTON, .type_info_ptr = (const type_info_struct*)&type_info_enum_widget_flags_t_const_data},
	{.name = "UI_WIDGET_FLAG_LABLED_BUTTON", .member_enum = TYPE_WIDGET_FLAGS_T_MEMBER_UI_WIDGET_FLAG_LABLED_BUTTON, .type_info_ptr = (const type_info_struct*)&type_info_enum_widget_flags_t_const_data},
