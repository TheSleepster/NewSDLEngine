...
struct type_info_struct_ui_signal_t {
	...
	union {
		...
		struct {
			...
			type_info_member_t is_hot;
			type_info_member_t is_active;
...
const static type_info_struct_ui_signal_t type_info_struct_ui_signal_t_const_data = {
	...
	.members = {
		...
		.is_hot = {.name = "is_hot", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.is_hot)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), is_hot))},
		.is_active = {.name = "is_active", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.is_active)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), is_active))},
		.is_held = {.name = "is_held", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.is_held)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), is_held))},
		.just_clicked = {.name = "just_clicked", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.just_clicked)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), just_clicked))},
		.just_released = {.name = "just_released", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.just_released)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), just_released))},
		.is_double_clicked = {.name = "is_double_clicked", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.is_double_clicked)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), is_double_clicked))},
		.is_right_clicked = {.name = "is_right_clicked", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.is_right_clicked)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), is_right_clicked))},
	}
};
...
enum ui_signal_t_member_list_enum {
	...
	TYPE_UI_SIGNAL_T_MEMBER_is_hot,
	TYPE_UI_SIGNAL_T_MEMBER_is_active,
	TYPE_UI_SIGNAL_T_MEMBER_is_held,
	TYPE_UI_SIGNAL_T_MEMBER_just_clicked,
	TYPE_UI_SIGNAL_T_MEMBER_just_released,
	TYPE_UI_SIGNAL_T_MEMBER_is_double_clicked,
	TYPE_UI_SIGNAL_T_MEMBER_is_right_clicked,
};
