...
#define GENERATED_PROGRAM_TYPE_LIST(X) \
	...
	X(TYPE_interaction_data_t, type_id(interaction_data_t), "interaction_data_t") \
...
const static interaction_data_t GENERATED_DEFAULT_interaction_data_t = {};
...
struct type_info_struct_interaction_data_t {
	const char *name;
	u32 type;
	u32 kind;
	u32 modifier_flags;
	...
	union {
		...
		struct {
			...
			type_info_member_t is_clicked;
			type_info_member_t is_hot;
			type_info_member_t is_open;
		}members;
	};
};
...
const static type_info_struct_interaction_data_t type_info_struct_interaction_data_t_const_data = {
	.name = "interaction_data_t",
	.type = TYPE_interaction_data_t,
	.kind = META_TYPE_KIND_Struct,
	.modifier_flags = META_TYPE_FLAGS_None,
	.flag_counter = 0,
	.element_size = sizeof(GENERATED_DEFAULT_interaction_data_t),
	.member_count = 4,
	.members = {
		.last_interacted_frame = {.name = "last_interacted_frame", .type = TYPE_u64, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_interaction_data_t.last_interacted_frame)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_interaction_data_t), last_interacted_frame))},
		.is_clicked = {.name = "is_clicked", .type = TYPE_bool32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_interaction_data_t.is_clicked)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_interaction_data_t), is_clicked))},
		.is_hot = {.name = "is_hot", .type = TYPE_bool32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_interaction_data_t.is_hot)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_interaction_data_t), is_hot))},
		.is_open = {.name = "is_open", .type = TYPE_bool32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_interaction_data_t.is_open)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_interaction_data_t), is_open))},
	}
};
...
enum interaction_data_t_member_list_enum {
	TYPE_INTERACTION_DATA_T_MEMBER_last_interacted_frame,
	TYPE_INTERACTION_DATA_T_MEMBER_is_clicked,
	TYPE_INTERACTION_DATA_T_MEMBER_is_hot,
	TYPE_INTERACTION_DATA_T_MEMBER_is_open,
};
...
const static type_info_t GENERATED_type_table[] = {
	...
	{.name = "interaction_data_t", .type = TYPE_interaction_data_t, .size = sizeof(interaction_data_t), .struct_info = (type_info_struct_t*)&type_info_struct_interaction_data_t_const_data},
