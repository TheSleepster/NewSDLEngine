...
const static type_info_struct_image_t type_info_struct_image_t_const_data = {
	...
	.members = {
		...
		.backend_image = {.name = "backend_image", .type = TYPE_backend_image_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_image_t.backend_image)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_image_t), backend_image))},
	}
};
...
const static type_info_struct_vec4_t type_info_struct_vec4_t_const_data = {
	...
	.members = {
		...
		.left = {.name = "left", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.left)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), left))},
		.right = {.name = "right", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.right)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), right))},
		.top = {.name = "top", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.top)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), top))},
		.bottom = {.name = "bottom", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.bottom)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), bottom))},
		.r = {.name = "r", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.r)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), r))},
		.g = {.name = "g", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.g)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), g))},
		.b = {.name = "b", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.b)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), b))},
		.a = {.name = "a", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vec4_t.a)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vec4_t), a))},
...
const static type_info_struct_shader_t type_info_struct_shader_t_const_data = {
	...
	.members = {
		...
		.shader_data = {.name = "shader_data", .type = TYPE_backend_shader_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_shader_t.shader_data)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_shader_t), shader_data))},
	}
};
...
const static type_info_struct_dynamic_render_font_varient_t type_info_struct_dynamic_render_font_varient_t_const_data = {
	...
	.members = {
		...
		.size_to_pixels = {.name = "size_to_pixels", .type = TYPE_float64, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_dynamic_render_font_varient_t.size_to_pixels)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_dynamic_render_font_varient_t), size_to_pixels))},
...
const static type_info_struct_tokenizer_t type_info_struct_tokenizer_t_const_data = {
	...
	.members = {
		...
		.read_bookmark = {.name = "read_bookmark", .type = TYPE_byte, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_tokenizer_t.read_bookmark)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_tokenizer_t), read_bookmark))},
		.bookmarked_token = {.name = "bookmarked_token", .type = TYPE_token_data_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_tokenizer_t.bookmarked_token)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_tokenizer_t), bookmarked_token))},
	}
};
...
const static type_info_struct_widget_state_t type_info_struct_widget_state_t_const_data = {
	...
	.member_count = 11,
	.members = {
		.last_interacted_frame = {.name = "last_interacted_frame", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.last_interacted_frame)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), last_interacted_frame))},
		.toggled = {.name = "toggled", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.toggled)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), toggled))},
		.dragging = {.name = "dragging", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.dragging)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), dragging))},
		.input_begin_within_bounds = {.name = "input_begin_within_bounds", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.input_begin_within_bounds)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), input_begin_within_bounds))},
		.slider_value = {.name = "slider_value", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.slider_value)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), slider_value))},
		.position = {.name = "position", .type = TYPE_vec3_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.position)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), position))},
		.offset = {.name = "offset", .type = TYPE_vec2_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.offset)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), offset))},
		.initial_mouse_position = {.name = "initial_mouse_position", .type = TYPE_vec2_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.initial_mouse_position)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), initial_mouse_position))},
		.render_size = {.name = "render_size", .type = TYPE_vec2_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.render_size)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), render_size))},
		.render_color = {.name = "render_color", .type = TYPE_vec4_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.render_color)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), render_color))},
		.widget_rect = {.name = "widget_rect", .type = TYPE_rectangle2_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.widget_rect)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), widget_rect))},
	}
};
...
const static type_info_struct_ui_signal_t type_info_struct_ui_signal_t_const_data = {
	...
	.member_count = 2,
	.members = {
		.widget = {.name = "widget", .type = TYPE_widget_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.widget)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), widget))},
		.signal_flags = {.name = "signal_flags", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_ui_signal_t.signal_flags)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_ui_signal_t), signal_flags))},
	}
};
...
const static type_info_struct_vulkan_image_info_t type_info_struct_vulkan_image_info_t_const_data = {
	...
	.members = {
		...
		.final_layout = {.name = "final_layout", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vulkan_image_info_t.final_layout)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vulkan_image_info_t), final_layout))},
...
const static type_info_struct_vulkan_image_t type_info_struct_vulkan_image_t_const_data = {
	...
	.member_count = 13,
	.members = {
		.is_valid = {.name = "is_valid", .type = TYPE_bool8, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vulkan_image_t.is_valid)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vulkan_image_t), is_valid))},
		...
		.renderpass_initial_layout = {.name = "renderpass_initial_layout", .type = TYPE_VkImageLayout, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vulkan_image_t.renderpass_initial_layout)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vulkan_image_t), renderpass_initial_layout))},
		.renderpass_final_layout = {.name = "renderpass_final_layout", .type = TYPE_VkImageLayout, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_vulkan_image_t.renderpass_final_layout)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_vulkan_image_t), renderpass_final_layout))},
...
const static type_info_struct_camera_matrices_t type_info_struct_camera_matrices_t_const_data = {
	...
	.member_count = 2,
	.members = {
		.view_matrix = {.name = "view_matrix", .type = TYPE_mat4_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_camera_matrices_t.view_matrix)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_camera_matrices_t), view_matrix))},
		.projection_matrix = {.name = "projection_matrix", .type = TYPE_mat4_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_camera_matrices_t.projection_matrix)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_camera_matrices_t), projection_matrix))},
	}
};
...
const static type_info_struct_render_buffer_t type_info_struct_render_buffer_t_const_data = {
	...
	.members = {
		...
		.constant_buffer_hash_ID = {.name = "constant_buffer_hash_ID", .type = TYPE_u64, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_buffer_t.constant_buffer_hash_ID)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_buffer_t), constant_buffer_hash_ID))},
		.buffer_ID = {.name = "buffer_ID", .type = TYPE_u64, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_buffer_t.buffer_ID)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_buffer_t), buffer_ID))},
		...
		.working_offset = {.name = "working_offset", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_buffer_t.working_offset)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_buffer_t), working_offset))},
		.mapped_data = {.name = "mapped_data", .type = TYPE_byte, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_buffer_t.mapped_data)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_buffer_t), mapped_data))},
...
const static type_info_struct_render_command_end_renderpass_t type_info_struct_render_command_end_renderpass_t_const_data = {
	...
	.member_count = 1,
	.members = {
		.ID = {.name = "ID", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_end_renderpass_t.ID)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_end_renderpass_t), ID))},
	}
};
...
const static type_info_struct_render_command_update_uniform_constant_buffer_t type_info_struct_render_command_update_uniform_constant_buffer_t_const_data = {
	...
	.members = {
		...
		.buffer = {.name = "buffer", .type = TYPE_uniform_constant_buffer_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_update_uniform_constant_buffer_t.buffer)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_update_uniform_constant_buffer_t), buffer))},
		...
		.constant_buffer_offset = {.name = "constant_buffer_offset", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_update_uniform_constant_buffer_t.constant_buffer_offset)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_update_uniform_constant_buffer_t), constant_buffer_offset))},
	}
};
...
const static type_info_struct_render_command_update_render_buffer_contents_t type_info_struct_render_command_update_render_buffer_contents_t_const_data = {
	...
	.member_count = 3,
	.members = {
		.buffer = {.name = "buffer", .type = TYPE_render_buffer_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_Pointer, .flag_counter = 1, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t.buffer)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t), buffer))},
		.offset = {.name = "offset", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t.offset)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t), offset))},
		.data_size = {.name = "data_size", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t.data_size)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_render_command_update_render_buffer_contents_t), data_size))},
	}
};
...
const static type_info_struct_renderpass_key_t type_info_struct_renderpass_key_t_const_data = {
	...
	.member_count = 1,
	.members = {
		.attachment_formats = {.name = "attachment_formats", .type = TYPE_bitmap_format_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_renderpass_key_t.attachment_formats)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_renderpass_key_t), attachment_formats))},
	}
};
...
const static type_info_struct_renderpass_t type_info_struct_renderpass_t_const_data = {
	...
	.members = {
		...
		.renderpass_key = {.name = "renderpass_key", .type = TYPE_renderpass_key_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_renderpass_t.renderpass_key)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_renderpass_t), renderpass_key))},
		...
		.framebuffer_handle = {.name = "framebuffer_handle", .type = TYPE_backend_framebuffer_handle_t, .kind = META_TYPE_KIND_Struct, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_renderpass_t.framebuffer_handle)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_renderpass_t), framebuffer_handle))},
