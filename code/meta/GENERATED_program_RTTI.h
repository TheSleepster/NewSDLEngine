...
struct type_info_struct_widget_t {
	...
	union {
		...
		struct {
			...
			type_info_member_t top_left_radius;
			type_info_member_t top_right_radius;
			type_info_member_t bottom_right_radius;
			type_info_member_t bottom_left_radius;
...
const static type_info_struct_widget_t type_info_struct_widget_t_const_data = {
	...
	.members = {
		...
		.top_left_radius = {.name = "top_left_radius", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_t.top_left_radius)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_t), top_left_radius))},
		.top_right_radius = {.name = "top_right_radius", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_t.top_right_radius)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_t), top_right_radius))},
		.bottom_right_radius = {.name = "bottom_right_radius", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_t.bottom_right_radius)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_t), bottom_right_radius))},
		.bottom_left_radius = {.name = "bottom_left_radius", .type = TYPE_float32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_t.bottom_left_radius)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_t), bottom_left_radius))},
...
enum widget_t_member_list_enum {
	...
	TYPE_WIDGET_T_MEMBER_top_left_radius,
	TYPE_WIDGET_T_MEMBER_top_right_radius,
	TYPE_WIDGET_T_MEMBER_bottom_right_radius,
	TYPE_WIDGET_T_MEMBER_bottom_left_radius,
