...
struct type_info_struct_widget_state_t {
	...
	union {
		...
		struct {
			...
			type_info_member_t min_slider_value;
			type_info_member_t max_slider_value;
			type_info_member_t position;
			type_info_member_t offset;
...
const static type_info_struct_widget_state_t type_info_struct_widget_state_t_const_data = {
	...
	.members = {
		...
		.min_slider_value = {.name = "min_slider_value", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.min_slider_value)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), min_slider_value))},
		.max_slider_value = {.name = "max_slider_value", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_state_t.max_slider_value)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_state_t), max_slider_value))},
...
const static type_info_struct_widget_t type_info_struct_widget_t_const_data = {
	...
	.members = {
		...
		.our_offset = {.name = "our_offset", .type = TYPE_u32, .kind = META_TYPE_KIND_Primitive, .modifier_flags = META_TYPE_FLAGS_None, .flag_counter = 0, .pointer_depth = 0, .array_size = 0, .size = sizeof(decltype(GENERATED_DEFAULT_widget_t.our_offset)), .offset = IntFromPtr(OffsetOf(decltype(GENERATED_DEFAULT_widget_t), our_offset))},
...
enum widget_state_t_member_list_enum {
	...
	TYPE_WIDGET_STATE_T_MEMBER_min_slider_value,
	TYPE_WIDGET_STATE_T_MEMBER_max_slider_value,
...
enum widget_t_member_list_enum {
	...
	TYPE_WIDGET_T_MEMBER_our_offset,
