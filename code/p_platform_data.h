...
bool8         sys_file_read(file_t *file_data, void *memory, s64 bytes_to_read, s64 file_offset);
bool8         sys_file_write(file_t *file_data, void *memory, s64 bytes_to_write);
...
s32           sys_directory_get_file_count(memory_arena_t *arena, string_t filepath, bool8 recursive, string_t file_ext);
...
s32             sys_thread_wait(sys_thread_t *handle);
