...
struct vulkan_context_t 
{
    ...
    hash_table_t<VkSampler>             image_samplers;
...
VkPipeline  vk_backend_create_render_pipeline(vulkan_context_t *vulkan_context, vulkan_shader_t *shader, VkRenderPass renderpass, const VkPipelineRasterizationStateCreateInfo *rasterization_state, const VkPipelineDepthStencilStateCreateInfo *depth_stencil_state, const VkPipelineColorBlendAttachmentState *blend_settings, VkPipelineVertexInputStateCreateInfo *pipeline_vertex_input_state, VkPrimitiveTopology topology);
