...
byte*          c_bootstap_structure(u32 structure_size, u32 offset_to_arena, u64 block_size);
...
/*===========================================
  ============= SCRATCH ARENAS  =============
  ===========================================*/
inline scratch_arena_t c_begin_temporary_memeory(memory_arena_t *arena);
inline void            c_end_temporary_memory(scratch_arena_t *scratch_arena);
